...
#
###########################################################################################################################
from .externals import GroupGQLModel, UserGQLModel, AcSubjectGQLModel
schema = strawberry.federation.Schema(Query, mutation=Mutation, types=(GroupGQLModel, UserGQLModel, AcSubjectGQLModel))
